---
title: "Fluorcam data analysis - Fv/Fm detached leaves"
author: ""
...
time_order <- c("T0", "T2H-HL", "T0.5H-R", "T2H-R", "T4H-R")  # your time point
...
**Order for the mesuring time point in the graph**<br> 
`r {"time_order: "}`
`r time_order`<br>
...
The recovery ratio is the ratio between T4-R/T0
...
ggsave("ratio_plot.svg", width=8, height=3)

write.table(recovery, file = "recovery.txt", 
              quote = FALSE, row.names = FALSE, sep = '\t')
